...
public class JdbcInsert2 {
	...
	public static void main(String[] args) {
		...
		final String datubaseIzena = "hr";
		final String url = "jdbc:mysql://localhost:3306/" + datubaseIzena;
		...
		try {
			...
			String insertSententzia = "INSERT INTO HR.Employees (Employee_id, first_name, last_name, Email, Hire_date, Job_Id) VALUES (?,?,?,?,?,?)";
